...
void mainImage( out vec4 fragColor, in vec2 fragCoord )
{
    ...
    _slider(20, 80, 1, 0.) _M _A
    _slider(20,110, 2, 0.) _M _e _t _a _l _l _i _c
    _slider(20,140, 3, 0.) _M _S
    _slider(20,170, 4, 0.) _M _q
    _slider(20,200, 5, 0.) _M _e _t
    _slider(20,2300, 6, 0.) _M _e _t _a
